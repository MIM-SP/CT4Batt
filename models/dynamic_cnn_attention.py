...
class Attention2D(nn.Module):
    ...
    """
    def __init__(self, in_channels, ratio=0.25, num_kernels=4, temperature=34, kernel_size=1, activation_fn=nn.ReLU, init_weight=True):
        ...
        self.fc1 = nn.Conv2d(in_channels, hidden_channels, kernel_size=kernel_size, bias=False)
        self.fc2 = nn.Conv2d(hidden_channels, num_kernels, kernel_size=kernel_size, bias=True)
...
class CNN2D(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, kernel_size=3, ratio=0.25, stride=1, padding=0, dilation=1, groups=1, bias=True, num_kernels=4, temperature=34, activation_fn=nn.ReLU, init_weight=True):
